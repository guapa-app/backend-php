                ...
                <div class="col-lg-6 col-12 mb-3">
                    <div class="contain">
                        ...
                        <div class="mobile-button">
                            <a href="#" class="download-btn">
                                <img src="{{ asset('frontend/assets/images/icons/app-store.svg') }}" loading="lazy" alt=""/>
                            </a>

                            <a href="#" class="download-btn">
                                <img src="{{ asset('frontend/assets/images/icons/google_play.svg') }}" loading="lazy" alt=""/>
                            </a>
                        </div>
                  ...
                  <span>
                    ...
                    4.5 out of 5
                            ...
                            <img src="{{ asset('frontend/assets/images/icons/stars.svg') }}" loading="lazy" alt=""/>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-3 col-12 mb-3">
                    <div class="box">
                        <img src="{{ asset('frontend/assets/images/feature/feature_1.svg') }}" loading="lazy" alt=""/>
                ...
                <div class="col-lg-3 col-12 mb-3">
                    <div class="box">
                        <img src="{{ asset('frontend/assets/images/feature/feature_2.svg') }}" loading="lazy" alt=""/>
                ...
                <div class="col-lg-3 col-12 mb-3">
                    <div class="box">
                        <img src="{{ asset('frontend/assets/images/feature/feature_3.svg') }}" loading="lazy" alt=""/>
                ...
                <div class="col-lg-3 col-12 mb-3">
                    <div class="box">
                        <img src="{{ asset('frontend/assets/images/feature/feature_4.svg') }}" loading="lazy" alt=""/>
    ...
    <section class="take general-section">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-12 mb-3">
                    <div class="image-contain">
                        <img src="{{ asset('frontend/assets/images/take/take_it.svg') }}" loading="lazy" alt=""/>
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-12 mb-3">
                    <div class="contain">
                        <ul class="list">
                            <li>
                                <img src="{{ asset('frontend/assets/images/take/take_1.svg') }}" loading="lazy" alt=""/>
                            ...
                            <li>
                                <img src="{{ asset('frontend/assets/images/take/take_2.svg') }}" loading="lazy" alt=""/>
                            ...
                            <li>
                                <img src="{{ asset('frontend/assets/images/take/take_3.svg') }}" loading="lazy" alt=""/>
