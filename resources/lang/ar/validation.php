...
return [
    ...
    'attributes'           => [
        ...
        'user.password'                         => 'الرقم السري',

        'vendor.name'                           => 'اسم النشاط',
        'vendor.type'                           => 'المجال',
        'vendor.email'                          => 'البريد الاكتروني للتواصل',
        'vendor.phone'                          => 'رقم الهاتف للتواصل',
        'vendor.about'                          => 'وصف النشاط',
        'vendor.tax_number'                     => 'رقم ضريبي',
        'vendor.cat_number'                     => 'رقم التصنيف',
        'vendor.reg_number'                     => 'رقم السجل التجاري',
        'vendor.logo'                           => 'شعار',
        'vendor.whatsapp'                       => 'واتساب',
        'vendor.twitter'                        => 'تويتر',
        'vendor.instagram'                      => 'انستجرام',
        'vendor.snapchat'                       => 'سناب شات',
        'vendor.website_url'                    => 'موقع الكتروني',
        'vendor.known_url'                      => 'رابط معروف',

        'vendor.address.city_id'                => 'المدينه',
        'vendor.address.type'                   => 'نوع العنوان',
        'vendor.address.address_1'              => 'العنوان 1',
        'vendor.address.address_2'              => 'العنوان 2',
    ],
];
