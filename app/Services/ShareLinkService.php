...
class ShareLinkService
{
    public function create($data): string
    {
        ...
        $shareLink = ShareLink::query()->firstOrCreate(
            [
                'shareable_type' => $data['type'], // Store fully qualified class name
                'shareable_id' => $data['id'], // Store shareable ID
            ],
            [
    ...
    public function handleRedirect($itemUrl, $shareLink)
    {
