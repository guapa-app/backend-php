    ...
    <div class="cs-invoice_in" id="download_section">
        ...
        <ul class="cs-grid_row cs-col_3 cs-mb5">
            ...
            <li class="text-in-same-line cs-text_center" style="font-size: 12px; margin-top: -18%">
                <p class="cs-mb20"><span>{{ $invoice->transaction_number }}</span></p>
                    ...
                    <table>
                        <thead>
                            <tr class="cs-focus_bg text-in-same-line">
                                <th class="s-custom-font cs-width_2 cs-semi_bold cs-primary_color cs-text_center">
                                    Details
                                    <br>تفاصيل المنتج
                                </th>
                        ...
                        <tbody>
                            <tr>
                                <td class="s-custom-font cs-width_2"> شحن رصيد </td>
                                <td class="s-custom-font cs-width_2 cs-text_center cs-primary_color">100</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
        ...
        <div class="cs-note" style="margin-top: 1%">
            <div class="cs-note_right">
                ...
                <p class="cs-m1">
                    - The amount paid represents the marketing fees for Guapa’s services. You must complete the payment
                    of
                    the remaining amount of the coupon value to the service provider to receive the service mentioned in
                    the
                    coupon.
                    <br>- The coupon and the service or product provided within it are subject to the terms of the
                    service
                    provider mentioned on the page of the coupon or product mentioned.
                    <br>- The terms and conditions of the application, as well as the conditions for return, are applied
                    as
                    mentioned in the General Terms and Conditions and Usage Policies section in the application.
                </p>
                <p class="cs-m0 ar-info">
                    - المبلغ المدفوع يمثل الاجور التسويقية لخدمات قوابا. يجب اكمال دفع المبلغ المتبقي من قيمة الكوبون
                    لدئ
                    مزود الخدمة لتلقي الخدمة المذكورة في الكوبون.
                    <br>- يخضع الكوبون و الخدمة المقدمة فيه او المنتج لشروط مزود الخدمة المذكورة في الصفحة الخاصة
                    بالكوبون
                    او المنتج المذكور.
                    <br>- يتم تطبيق الشروط و الاحكام الخاصة بالتطبيق و كذلك الشروط الخاصة بالاسترجاع كما هو مذكور في
                    خانة
