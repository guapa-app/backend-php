            ...
            <div class="row">
                <div class="col-12">
                    <div class="service-motto text-center">
                        <h2 class=" wow slideInDown" data-wow-delay="1s">لو كنت مزود خدمة، كيف منصة قوابا ممكن تفيدك؟
                        </h2>
                        ...
                        <div class="col-lg-3 col-md-6  col-ms-12">
                            <div class="service-item">
                                ...
                                <p class=" wow slideInDown" data-wow-delay="1s">
                                    ...
                                    في مجتمع قوابا ، شارك المهتمين بعالم الجمال وكن على تواصل معهم وزودهم بالمعلومات
                                    الصحيحة
                                    وزيد من تقيمك
            ...
            <div class="row">
                ...
                <div class=" col-lg-6 col-md-12 col-sm-12">
                    <div class="benefits-text">
                        <h2 class=" wow slideInRight" data-wow-delay="1s"> اذا كنت مستخدم للخدمات ، كيف تساعدك منصة
                            قوابا
                            ؟ </h2>
                        ...
                        <div class="benefit-item d-flex">
                            <p class=" wow slideInDown" data-wow-delay="1s">
                                تصفح وابحث عن العديد من المنتجات والمستحضرات التجميلية و العروض الخاصة بها مع امكانية
                                طلبها
                    ...
                    <div class="text-recommend">
                        ...
                        <div class="downloads-app d-flex">
                            ...
                            <a href="https://play.google.com/store/apps/details?id=com.guapa.app" class="m-3">
                                <img src="{{ asset('landing/img/google-play.png') }}" class="google-play"
                                    alt="google-play">
                            </a>
                        </div>
