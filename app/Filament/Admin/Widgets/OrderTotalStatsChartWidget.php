...
class OrderTotalStatsChartWidget extends ChartWidget
{
    protected static ?string $heading = 'Orders Total per month';
    ...
    protected function getData(): array
    {
        ...
        foreach ($ordersData as $order) {
            $monthlyCounts[$order->status->value][$order->month] = $order->total;
        }
